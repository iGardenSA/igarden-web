...
Tagline (عربي):            ازرع بذكاء.
Tagline (إنجليزي):         Plant smart.
قاعدة الـ Tagline:         كل لغة منفردة في سياقها — لا يُجمعان في سطر واحد أبداً
```
...
│   │   ├── HeroSection.tsx              ← «نبني · نُوطّن · نُطوّر»
│   │   ├── TrustBar.tsx
...
- ✅ Tagline عربي `ازرع بذكاء.` في Hero + Footer + Signatures العربية
- ✅ Tagline إنجليزي `Plant smart.` في السياقات الإنجليزية فقط
- ❌ لا تجمع `ازرع بذكاء · Plant smart` في سطر واحد أبداً
...
- **حريصاً** على التموضع الجديد (نبني · نُوطّن · نُطوّر) في كل مخرج
