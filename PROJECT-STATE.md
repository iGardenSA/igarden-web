...
- **`main` = `origin/main` = `af33e312042748088470819e1e87484d10cfef69`** ✓
- **نشر إنتاجي مُتحقَّق:** `sha=af33e31` · `2026-08-23T14:26:01Z` · `Production id=6049016417` ✓
- مسار `main`: `3d235c0` → `25d6588` → `02d3c3e` → `6166e2a` → `14f59bd` → **`af33e31`** ✓
...
**Wave 1B** — بوّابة `/products` بالعائلات الأربع + `/how-we-work` بمسارين
(`new-project` · `existing-facility`). فرع `feat/wave1b-catalog` من `af33e31`.
خارج النطاق: محتوى صفحات المنتجات الخمس · `+45°C` و«لحظياً» داخلها ·
صفحة الاستدامة المستقلة · Evidence Pack · صفحة الواحة · تمريرة الصور النهائية · #43.
