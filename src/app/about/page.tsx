        ...
        <div className="bg-cream rounded-card p-8 md:p-10 shadow-soft">
          <div className="space-y-4 body-base text-medium-gray leading-relaxed">
            ...
            <p>
              ...
              كلّ خطّ في كلّ لوحة Smart Controller مَرسوم في جدة. نطوّر ونختبر
              في مرفق R&D في عسفان نماذج وتقنيات مختارة قبل توسيعها إلى نطاقات
              العملاء. وكلّ ما نتعلّمه من فشل النموذج، نُترجمه إلى إصدار أفضل.
            </p>
            <p>
...
const METHODOLOGY = [
  {
    ...
    example: "في صيف 2025 نفّذنا أوّل نظام DWC في مرفق R&D في عسفان. تحت الحرارة ظهرت مشكلة في الجذور، فأعَدنا التنفيذ بـ Heat Exchanger مُدمَج — وصار جزءاً من تصميم DWC لدينا. /* [CONTENT_NEEDED: سجلّ التجربة — المدة الفعلية ونتيجة القياس، من م. أيمن] */",
  },
  {
    Icon: Globe2,
    verb: "نُوطّن",
    ...
    example: "كنّا نَستورد لوحات تحكّم بأسعار مرتفعة وقطع غيار بانتظار شحنات. طوّرنا نسختنا في جدة — بتوفير ودعم لقطع الغيار محلياً ودعم فني داخل السعودية. /* [CONTENT_NEEDED: مقارنة التكلفة والدقّة تحتاج سنداً مقيساً قبل نشرها] */",
  },
  {
    Icon: Microscope,
    verb: "نُطوّر",
    ...
    example: "Smart Controller v0.1 كان يَخطئ في قراءة pH تحت حرارة الصيف. v0.2 يَستخدم ADC عالي الدقة (ADS1115) لقراءة الإشارة التناظرية، والدقّة النهائية تعتمد على المجس والمعايرة والتركيب — مدعومة بتغطية اختبارات وحدوية موسّعة. /* [CONTENT_NEEDED: سجلّ قياس دقّة pH للإصدارين v0.1 وv0.2] */",
  },
];
...
const VALUES = [
  ...
  },
  {
    ...
    desc: "نُخضع النماذج والتقنيات المختارة لدورة اختبار في مرفق R&D في عسفان قبل توسيعها إلى نطاقات العملاء. لا prototype في موقعك — نُسلّم ما أثبت نفسه.",
  },
  {
    title: "شريك لا بائع",
