...
/**
 * محتوى /contact التفاعلي — نُقل من page.tsx كما هو (⛔ صفر تغيير في الترميز
 * أو النصّ أو المنطق) كي يصير page.tsx مكوّن خادم يحمل metadata وcanonical.
 * السبب: "use client" على مستوى الصفحة يمنع `export const metadata`، فكانت
 * صفحة التحويل ترث canonical الجذر من layout.tsx وتُقرأ كنسخة من الرئيسية.
 */
