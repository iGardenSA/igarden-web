...
export const metadata: Metadata = {
  ...
  description:
    "شركة سعودية متخصّصة مُرخّصة من وزارة الاستثمار، تقدّم حلول الزراعة المُحكَمة بتقنيات IoT والذكاء الاصطناعي، مُختبَرة في مرفق R&D بعسفان. منذ 2024.",
  keywords: [
    "iGarden",
    "الحديقة الذكية",
    "زراعة ذكية",
  ...
  openGraph: {
    ...
    description:
      "شركة سعودية متخصّصة مُرخّصة · حلول IoT والذكاء الاصطناعي للزراعة المُحكَمة · مُختبَرة في مرفق عسفان.",
    images: [
      {
  ...
  twitter: {
    ...
    title: `${COMPANY.nameEn} · الحديقة الذكية`,
    description:
      "شركة سعودية متخصّصة مُرخّصة · حلول IoT والذكاء الاصطناعي للزراعة المُحكَمة.",
