...
const COMPARISON = [
  {
    ...
    hydro: "أقل بـ 90-95% للنبات الواحد (إعادة تدوير مستمرة)",
    trad: "استهلاك مرتفع — معظمه يتبخر أو ينضح في التربة",
    winner: "hydro",
  },
  {
    aspect: "كثافة الإنتاج",
    hydro: "حتى 10× أعلى في نفس المساحة (زراعة عمودية)",
        ...
        <div className="container mx-auto px-4 max-w-4xl py-12 md:py-16">
          ...
          <section className="mb-10">
            ...
            <p className="text-[#1A1A1A] leading-relaxed">
              النتيجة: منشآت هيدروبونيك تفشل لأن أصحابها لم يكونوا مستعدين تقنياً، أو مزارع تقليدية تستنزف مياه جوفية بتكلفة باهظة في مناطق كان يمكن فيها للهيدروبونيك توفير 90% من هذا الاستهلاك.
            </p>
          </section>
