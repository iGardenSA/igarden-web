        ...
        <div className="container mx-auto px-4 max-w-4xl py-12 md:py-16">
          ...
          <section className="mb-10 bg-[#0F3D2E]/5 rounded-xl p-6 border border-[#0F3D2E]/10">
            <p className="text-[#1A1A1A] leading-relaxed">
              <span dir="ltr" className="font-semibold">iGarden Smart Controllers</span> مُصمَّمة لهذه المرحلة تحديداً — الانتقال من المراقبة اليدوية إلى التشغيل القائم على البيانات، دون استبدال البنية التحتية القائمة بالكامل. اختُبرت في محطة عسفان لتحمّل حرارة الصيف السعودي.
            </p>
            <Link
