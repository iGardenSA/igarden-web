        ...
        <header className="bg-[#0F3D2E] py-16 md:py-20">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              الصيف السعودي يفرض ظروفاً يجب أن يُصمَّم لها النظام من البداية. أربعة أسباب وثمانية حلول.
            </p>
          </div>
        </header>
        ...
        <div className="container mx-auto px-4 max-w-4xl py-12 md:py-16">
          ...
          <section className="mb-10">
            ...
            <p className="text-[#1A1A1A] leading-relaxed mb-4">
              في درجات الحرارة المرتفعة خلال ذروة الصيف، ومع رطوبة ساحلية عالية في جدة، وأحمال كهربائية ضخمة على معدات التبريد — هذا المزيج يخلق ضغطاً تشغيلياً يجب أن يُؤخذ بالحسبان عند اختيار المعدات وتصميم النظام.
            </p>
