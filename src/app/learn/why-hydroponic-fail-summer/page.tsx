...
const SUMMER_CHECKLIST = [
  ...
  "جدولة تغيير المحلول الكامل كل أسبوعين إلى ثلاثة أسابيع (أقل في الحرارة الشديدة)",
  "مراجعة فلاتر الهواء وتهوية المنطقة الزراعية",
  "ضبط حساسات التنبيه لدرجة حرارة 26°C (قبل الوصول للحرج)",
  "تقليل تركيز EC بنسبة 10 إلى 15% في أوج الصيف (لتقليل ضغط الأملاح)",
...
const FAILURE_MODES = [
  ...
  },
  {
    ...
    detail:
      "درجات الحرارة العالية ترفع ضغط التشغيل على المحركات. المضخات التي تعمل بكفاءة 80% في الشتاء تجد نفسها عند 95 إلى 100% في الصيف. ترتفع احتمالية العطل، وأي توقّف حتى لساعات قليلة قد يُسبّب خسائر كاملة في المحصول.",
    risk: "متوسط-عالٍ",
  },
  {
    num: "٤",
