        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="body-base text-medium-gray mb-4 max-w-lg">
              نختبر ونشغّل أنظمة زراعة مائية ونماذج تحكّم مختارة في مرفق R&D في عسفان، لنتعلّم من ظروف التشغيل المحلية قبل توسيع نطاق التنفيذ. نَختار النظام الأنسب لمحصولك ومساحتك
...
const VALUES = [
  ...
  {
    Icon: TrendingUp,
    title: "إمكان تحسين الإنتاجية بحسب التقنية والمحصول والتشغيل",
    text: "قد ترفع الزراعة العمودية الإنتاج لكل متر مربع، بحسب التقنية والمحصول ودورة النمو.",
  },
  {
    Icon: Leaf,
...
const SCOPE_INCLUDES = [
  ...
  "متابعة تشغيلية بعد التسليم وفق خطة التسليم المتفق عليها",
...
const FAQS = [
  ...
  {
    q: "لماذا صُمِّم iGarden Tower محلياً؟",
    a: "صُمِّم iGarden Tower ليعمل في الحرارة والرطوبة العالية التي نختبره فيها في عسفان، وقالبه وأجزاؤه البلاستيكية تُنتَج محلياً بالتعاون مع مصنّعين محلّيين. ويتحدّد توفير قطع الغيار ودعمها محلياً بحسب مكوّنات المشروع ونطاقه.",
  },
];
...
const SCHEMA_FAQS = [
  ...
  {
    question: "لماذا صُمِّم iGarden Tower محلياً؟",
    answer:
      "صُمِّم iGarden Tower ليعمل في الحرارة والرطوبة العالية التي نختبره فيها في عسفان، وقالبه وأجزاؤه البلاستيكية تُنتَج محلياً بالتعاون مع مصنّعين محلّيين. ويتحدّد توفير قطع الغيار ودعمها محلياً بحسب مكوّنات المشروع ونطاقه.",
  },
];
