...
const FAQS = [
  ...
  },
  {
    ...
    a: "iGarden Tower مصمَّم للحرارة والرطوبة العالية. المستوردة مُصمَّمة لمناخات أوروبية وتحتاج تعديلات مكلفة. ويتحدّد توفير قطع الغيار ودعمها محلياً بحسب مكوّنات المشروع ونطاقه.",
  },
];
...
const SCHEMA_FAQS = [
  ...
  },
  {
    ...
    answer:
      "iGarden Tower مصمَّم للحرارة والرطوبة العالية. المستوردة مُصمَّمة لمناخات أوروبية وتحتاج تعديلات مكلفة. ويتحدّد توفير قطع الغيار ودعمها محلياً بحسب مكوّنات المشروع ونطاقه.",
  },
];
