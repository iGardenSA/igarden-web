          ...
          {pillars.map((p, i) => {
            ...
            return (
              <FadeIn key={p.title} delay={i * 120}>
                <div className="bg-white rounded-2xl border border-[var(--color-border)] p-7 md:p-8 shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-md)] hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
