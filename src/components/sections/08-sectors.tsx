          ...
          {sectors.map((s, i) => {
            ...
            return (
              <FadeIn key={s.title} delay={i * 100}>
                <div className="group bg-[var(--color-surface)] rounded-2xl p-7 md:p-8 border border-transparent hover:border-[var(--color-brand-300)] hover:bg-white transition-all duration-300 h-full">
