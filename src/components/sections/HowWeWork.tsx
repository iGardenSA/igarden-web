const STEPS = [
  ...
  },
  {
    ...
    desc: "نُصمّم النظام بمدخلات سعودية محلية، ونُكيّف التجهيزات وفق ظروف الموقع ومتطلبات التشغيل المحلية.",
  },
  {
    step: "03",
  ...
  },
  {
    ...
    desc: "Smart OS يُراقب وفق دورية القياس المحددة، وفريقنا يُحدّث الأنظمة باستمرار. مشروعك لا يتوقف بعد التسليم.",
  },
];
