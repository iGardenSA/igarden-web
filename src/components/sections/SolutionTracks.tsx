...
const TRACKS: Track[] = [
  {
    Icon: Sprout,
    num: "١",
    title: "مشروع مترابط من البداية — لا أجزاء تتولّى أنت جمعها",
  ...
  },
  {
    Icon: Cpu,
    num: "٢",
    title: "تعرف ما يجري في مزرعتك وأنت لست فيها",
  ...
  },
  {
    Icon: MonitorCog,
    num: "٣",
    title: "تشغيل يمكنك مراجعته — لا الاعتماد على الذاكرة وحدها",
  ...
  },
  {
    Icon: Sun,
    num: "٤",
    title: "المياه والطاقة تدخلان في القرار من البداية",
      ...
      <div className="container-igarden">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="body-base text-medium-gray leading-relaxed">
            ننسّق أنظمة الإنتاج والتحكّم والبيانات والعناصر المساندة ضمن نطاق
            مترابط، فتكون المسؤوليات ونقاط التواصل أوضح من بداية المشروع.
          </p>
        </div>
        ...
        {/* حدّ النطاق — مرة واحدة في نهاية القسم لا في كل بطاقة */}
        <p className="text-center text-sm text-medium-gray mt-10 max-w-3xl mx-auto leading-relaxed">
          تُحدَّد عناصر المنظومة وما يعمل محلياً أو عن بُعد وفق الموقع ونطاق
          التصميم والتجهيز المتفق عليه.
        </p>
      </div>
    </section>
  );
