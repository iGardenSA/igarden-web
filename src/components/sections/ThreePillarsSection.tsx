...
const PILLARS = [
  {
    ...
    img: { src: "/images/osfan-full/03_cabbage_diversity.webp", alt: "محاصيل خضار تحت مراقبة Smart Controllers داخل مرفق R&D في عسفان" },
  },
  {
    badge: null,
  ...
  },
  {
    ...
    img: { src: "/images/osfan-full/02_tower_closeup.webp", alt: "نظام iGarden Tower للزراعة العمودية — مُختبَر داخل مرفق R&D في عسفان" },
  },
];
